...
class BoardServiceImpl implements BoardService {
    ...
    @Override
    public List<BoardDto> getAll(Long orgId, Long projId) {
        return client.getBoards(orgId, projId);
    }

    @Override
    public BoardDto get(Long orgId, Long projId, Long boardId) throws PblCustomException {
        return client.getBoard(orgId, projId, boardId);
    }

    @Override
    public BoardDto create(Long orgId, Long projId, Long userId, BoardDto dto) throws PblCustomException {
        return client.createBoard(orgId, projId, dto);
    }

    @Override
    public BoardDto update(Long orgId, Long projId, Long boardId, Long userId, BoardDto dto) throws PblCustomException {
        return client.updateBoard(orgId, projId, boardId, dto);
    }

    @Override
    public void delete(Long orgId, Long projId, Long boardId, Long userId) throws PblCustomException {
        client.deleteBoard(orgId, projId, boardId);
    }
}
